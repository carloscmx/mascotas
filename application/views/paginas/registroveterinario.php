    ...
    <div class="card-block">
        ...
        <div class="account-box">
            ...
            <div class="card-box p-5">
                ...
                <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Registro veterinarios</h3>
                ...
                <form class="" action="" method="post" id="idFormRegistro">
                    ...
                    <div class="form-group m-b-20 row">
                        <div class="col-12">
                            <label for="text">numero de cedula</label>
                            <input class="form-control" type="text" name="txtcedula" required="" placeholder="cedula">
                        </div>
                    </div>
                    ...
                    <div class="form-group m-b-20 row">
                        <div class="col-12">
                            ...
                            <input class="form-control" type="text" name="txtlatitud" required="" placeholder="latitud">
                        </div>
                    </div>
                    <div class="form-group m-b-20 row">
                        <div class="col-12">
                            <label for="text">altitud</label>
                            <input class="form-control" type="text" name="txtaltitud" required="" placeholder="altitud">
                        </div>
                    </div>
